 ...
 * 资产报废
 */
public class InvalidAssets extends JFrame implements ActionListener,ListSelectionListener,ItemListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == modifyInfo) { //修改
			...
			atbean.add(JourNo,"设备报废",AssetsID,f4,PersonID,jTextField2.getText(),jTextField2.getText());
			//重新生成界面
			this.dispose();

			InvalidAssets invalidAssets = new InvalidAssets();
			invalidAssets.pack();
			invalidAssets.setVisible(true);
		}
